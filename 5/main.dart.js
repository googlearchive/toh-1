...
(function() {
  ...
  var dart = [["_foreign_helper", "dart:_foreign_helper",, H, {
    ...
    }, "call$1", "async___nullDataHandler$closure", 2, 0, 49, 19],
    ...
    _rootFork: [function($self, $parent, zone, specification, zoneValues) {
      ...
      return t1;
    }, "call$5", "async___rootFork$closure", 10, 0, 54, 11, 12, 10, 36, 35],
    ...
    }, "call$1", "core_Uri_decodeComponent$closure", 2, 0, 55, 30],
    ...
    }, "call$0", "modules__createEventPlugins$closure", 0, 0, 56],
    createNgZone: [function() {
      H.assertHelper(true);
      return Y.NgZone$(true);
    }, "call$0", "modules__createNgZone$closure", 0, 0, 57],
    ...
    initReflector_closure13: {
      ...
      }, null, null, 6, 0, null, 8, 13, 27, "call"]
    }
    ...
    _RuntimeInjector: {
      ...
      }, "useClass$1", "call$2$deps", "call$1", "get$useClass", 2, 3, 33, 0, 41, 23],
      ...
      }, "useFactory$1", "call$2$deps", "call$1", "get$useFactory", 2, 3, 35, 0, 43, 23],
    ...
    PublicTestability: {
      ...
      whenStable$1: [function(callback) {
        ...
        t1._runCallbacksIfReady$0();
      }, "call$1", "get$whenStable", 2, 0, 58, 15],
      ...
      }, "findBindings$2", "call$3", "call$1", "call$2", "get$findBindings", 2, 4, 39, 0, 0, 20, 48, 49],
    ...
    BrowserGetTestability_addToWindow_closure: {
      ...
      }, "call$1", null, null, null, 2, 2, null, 50, 20, 21, "call"]
    },
    ...
    ViewAppComponent0: {
      "^": "AppView;_el_0,_text_1,_el_2,_text_3,_el_5,_el_6,_text_8,_el_9,_el_10,_el_12,_DefaultValueAccessor_12_5,_NgValueAccessor_12_6,_NgModel_12_7,_expr_1,_expr_2,viewData,locals,parentView,componentType,rootEl,ctx",
      set$_NgValueAccessor_12_6: function(_NgValueAccessor_12_6) {
        this._NgValueAccessor_12_6 = H.assertSubtype(_NgValueAccessor_12_6, "$isList", [L.ControlValueAccessor], "$asList");
      },
      build$0: function() {
        var parentRenderNode, t1, doc, t2, _text_4, t3;
        ...
        this._text_3 = t1;
        J.append$1$x(t2, t1);
        _text_4 = doc.createTextNode(" details!");
        J.append$1$x(this._el_2, _text_4);
        t1 = S.createDivAndAppend(doc, parentRenderNode);
        this._el_5 = t1;
        t1 = S.createAndAppend(doc, "label", t1);
        this._el_6 = t1;
        J.append$1$x(t1, doc.createTextNode("id:"));
        t1 = doc.createTextNode("");
        this._text_8 = t1;
        t2 = this._el_5;
        ...
        t1 = S.createAndAppend(doc, "label", t1);
        this._el_10 = t1;
        J.append$1$x(t1, doc.createTextNode("name:"));
        t1 = H.interceptedTypeCheck(S.createAndAppend(doc, "input", this._el_9), "$isInputElement");
        this._el_12 = t1;
        (t1 && C.InputElement_methods).setAttribute$2(t1, "placeholder", "name");
        t1 = new O.DefaultValueAccessor(this._el_12, H.functionTypeCheck(new O.closure8(), {func: 1, v: true, args: [,]}), H.functionTypeCheck(new O.closure9(), {func: 1, v: true}));
        this._DefaultValueAccessor_12_5 = t1;
        this.set$_NgValueAccessor_12_6([t1]);
        t1 = this._NgValueAccessor_12_6;
        ...
        t2 = this._el_12;
        t1 = this.eventHandler1$1(this.get$_handle_input_12_1());
        t2.toString;
        t3 = {func: 1, args: [W.Event]};
        H.functionTypeCheck(t1, t3);
        (t2 && C.InputElement_methods)._addEventListener$3(t2, "input", t1, null);
        t1 = this._el_12;
        t2 = this.eventHandler0$1(this._DefaultValueAccessor_12_5.get$touchHandler());
        t1.toString;
        H.functionTypeCheck(t2, t3);
        (t1 && C.InputElement_methods)._addEventListener$3(t1, "blur", t2, null);
        t1 = this._NgModel_12_7._update;
        t1.toString;
        t2 = H.getTypeArgumentByIndex(t1, 0);
        this.init$2(C.List_empty0, [H.assertSubtype(new P._BroadcastStream(H.assertSubtype(t1, "$is_StreamControllerLifecycle", [t2], "$as_StreamControllerLifecycle"), [t2]), "$isStream", [t2], "$asStream").listen$1(this.eventHandler1$1(this.get$_handle_ngModelChange_12_0()))]);
        return;
      },
      injectorGetInternal$3: function(token, nodeIndex, notFoundResult) {
        if (token === C.Type_DefaultValueAccessor_EOZ && 12 === nodeIndex)
          return this._DefaultValueAccessor_12_5;
        if (token === C.MultiToken_NgValueAccessor && 12 === nodeIndex)
          return this._NgValueAccessor_12_6;
        if ((token === C.Type_NgModel_qx4 || token === C.Type_NgControl_GNi) && 12 === nodeIndex)
          return this._NgModel_12_7;
        return notFoundResult;
      },
      detectChangesInternal$0: function() {
        var _ctx, firstCheck, t1, t2, t3, currVal_1, currVal_2;
        _ctx = this.ctx;
        firstCheck = this.viewData._cdState === 0;
        t1 = this._NgModel_12_7;
        t2 = _ctx.hero;
        t1.set$model(t2.name);
        this._NgModel_12_7.ngAfterChanges$0();
        if (firstCheck) {
          t1 = this._NgModel_12_7;
        ...
        currVal_1 = Q.interpolate0(t2.name);
        if (this._expr_1 !== currVal_1) {
          this._text_3.textContent = currVal_1;
          this._expr_1 = currVal_1;
        }
        currVal_2 = Q.interpolate0(t2.id);
      ...
      _handle_ngModelChange_12_0$1: [function($$event) {
        this.ctx.hero.name = H.stringTypeCheck($$event);
      }, "call$1", "get$_handle_ngModelChange_12_0", 2, 0, 12],
      ...
      }, "call$1", "get$_handle_input_12_1", 2, 0, 12],
      $asAppView: function() {
    ...
    _ViewAppComponentHost0: {
      ...
      build$0: function() {
        var t1, t2, t3, t4;
        t1 = new V.ViewAppComponent0(null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, null, H.assertSubtype(P.LinkedHashMap__makeEmpty(), "$isMap", [P.String, null], "$asMap"), this, null, null, null);
        ...
        t2 = new Q.AppComponent("Tour of Heroes", new Q.Hero(1, "Windstorm"));
...
;
  ...
  $ = new Isolate();
  init.metadata = [null, "_", "error", "line", "frame", "trace", "stackTrace", "arg", "p0", "result", "zone", "self", "parent", "p1", "arg2", "callback", "arg1", "invocation", "f", "value", "elem", "findInAncestors", "x", "deps", "t", "event", "e", "p2", "errorCode", "element", "encodedComponent", "s", "o", "ref", "err", "zoneValues", "specification", "arguments", "each", "chain", "arg4", "clazz", "arg3", "factory", "stack", "reason", "numberOfArguments", "theStackTrace", "binding", "exactMatch", true, "isolate", "didWork_", "closure", "sender", "object", "theError"];
  init.types = [{func: 1}, {func: 1, args: [,]}, {func: 1, v: true}, {func: 1, args: [,,]}, {func: 1, v: true, args: [{func: 1, v: true}]}, {func: 1, v: true, args: [P.Object], opt: [P.StackTrace]}, {func: 1, args: [, P.StackTrace]}, {func: 1, args: [P.bool]}, {func: 1, ret: P.String, args: [P.int]}, {func: 1, v: true, args: [P.Uint8List, P.String, P.int]}, {func: 1, ret: P.String}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, {func: 1, v: true}]}, {func: 1, v: true, args: [,]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.AsyncError, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Object, P.StackTrace]}, {func: 1, ret: P.int, args: [P.int, P.int]}, {func: 1, args: [P.Symbol0,,]}, {func: 1, args: [P.String,,]}, {func: 1, v: true, args: [P.String, P.int]}, {func: 1, v: true, args: [P.String], opt: [,]}, {func: 1, args: [P.int,,]}, {func: 1, ret: P.Uint8List, args: [,,]}, {func: 1, args: [, P.String]}, {func: 1, args: [P.String]}, {func: 1, ret: P.Future}, {func: 1, args: [Y.NgZoneError]}, {func: 1, args: [Y.PlatformRefImpl, Y.NgZone, M.Injector]}, {func: 1, args: [P.String, E.SanitizationService, N.EventManager]}, {func: 1, args: [M.ComponentLoader, V.ComponentResolver]}, {func: 1, args: [Y.NgZone]}, {func: 1, args: [,], opt: [,]}, {func: 1, v: true, args: [, U.Chain]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1}]}, {func: 1, ret: P.Object, args: [P.Type], named: {deps: [P.List, P.Object]}}, {func: 1, ret: P.Object, args: [P.Object]}, {func: 1, ret: P.Object, args: [P.Function], named: {deps: [P.List, P.Object]}}, {func: 1, v: true, args: [,], opt: [, P.String]}, {func: 1, ret: P.bool}, {func: 1, ret: S.AppView, args: [S.AppView, P.num]}, {func: 1, ret: P.List, args: [W.Element], opt: [P.String, P.bool]}, {func: 1, args: [W.Element], opt: [P.bool]}, {func: 1, args: [W.Element, P.bool]}, {func: 1, args: [[P.List, N.EventManagerPlugin], Y.NgZone]}, {func: 1, args: [,], named: {rawValue: P.String}}, {func: 1, args: [Z.AbstractControl]}, {func: 1, args: [{func: 1, v: true}]}, {func: 1, args: [P.Zone, P.ZoneDelegate, P.Zone,, P.StackTrace]}, {func: 1, ret: P.int, args: [[P.List, P.int], P.int]}, {func: 1, v: true, args: [P.int, P.int]}, {func: 1, v: true, args: [P.Object]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true}]}, {func: 1, ret: P.Timer, args: [P.Zone, P.ZoneDelegate, P.Zone, P.Duration, {func: 1, v: true, args: [P.Timer]}]}, {func: 1, v: true, args: [P.Zone, P.ZoneDelegate, P.Zone, P.String]}, {func: 1, v: true, args: [P.String]}, {func: 1, ret: P.Zone, args: [P.Zone, P.ZoneDelegate, P.Zone, P.ZoneSpecification, P.Map]}, {func: 1, ret: P.String, args: [P.String]}, {func: 1, ret: [P.List, N.EventManagerPlugin]}, {func: 1, ret: Y.NgZone}, {func: 1, v: true, args: [P.Function]}];
